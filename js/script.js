...
jQuery(function($) {
    ...
    $('#team_list a.item-image-a').mouseover(function() {
        var $this = $(this);
        var id = $this.attr('rel');
        var $currentWidget = $('#' + id);
        $currentWidget.show().siblings('.wrap-item-txt').hide();


        if($('#team_list .item-team.active')[0]){
            var boxshow = $(this).find('.item-txt');
            var h_boxshow = boxshow.innerHeight();
            console.log('height = ', h_boxshow);


            // $('#team_list .item-team.active .wrap-item-txt').css({
            //     height : ch + 50 + 'px'
            // })
        }
        ...
        // var ch = $('#team_list .item-team.active .item-txt').height();
        // // $('#team_list .item-team.active .wrap-item-txt').css({
        // //     height : ch + 50 + 'px'
        // // })

        // $('#team_list .item-team.active .item-txt').before('<div class="space-item-txt"></div>');
        // var spacei = $('.space-item-txt').innerHeight(ch);

    });

    $('#team_list .item-team').mouseover(function() {
        var $this = $(this);
        var boxshow =  $this.find('.item-txt');
